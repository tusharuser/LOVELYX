...
from MashaRoBot import TOKEN, bot, dp
from MashaRoBot.config import get_bool_key, get_list_key
from MashaRoBot.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
import_module("MashaRoBot.modules.pm_menu")
# Import misc stuff
import_module("MashaRoBot.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("MashaRoBot.utils.sentry")
